...
//		Yii::trace(get_class($this).'.count()','application.components.solr.ASolrDocument');
        if ($criteria === null) {
...
//		Yii::trace(get_class($this).'.find()','application.components.solr.ASolrDocument');
        if ($criteria === null) {
            $criteria = new ASolrCriteria();
        }
...
//		Yii::trace(get_class($this).'.findAll()','application.components.solr.ASolrDocument');
        if ($criteria === null) {
            $criteria = new ASolrCriteria();
        }
...
//		Yii::trace(get_class($this).'.findByPk()','application.components.solr.ASolrDocument');
        if ($criteria === null) {
            $criteria = new ASolrCriteria();
        }
        if (is_array($pk)) {
...
//		Yii::trace(get_class($this).'.findByAttributes()','application.components.solr.ASolrDocument');
        if ($criteria === null) {
            $criteria = new ASolrCriteria();
        }
        $query = array();
...
//		Yii::trace(get_class($this).'.findAllByAttributes()','application.components.solr.ASolrDocument');
        if ($criteria === null) {
            $criteria = new ASolrCriteria();
        }
        $query = array();
