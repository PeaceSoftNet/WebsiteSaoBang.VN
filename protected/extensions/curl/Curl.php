...
class Curl extends CApplicationComponent {
    ...
    protected function defaults() {
        ...
        isset($this->options['setOptions'][CURLOPT_SSL_VERIFYPEER]) ? $this->setOption(CURLOPT_SSL_VERIFYPEER, $this->options['setOptions'][CURLOPT_SSL_VERIFYPEER]) : $this->setOption(CURLOPT_SSL_VERIFYPEER, FALSE);
    }
