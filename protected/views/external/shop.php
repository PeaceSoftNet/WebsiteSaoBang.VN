...
<div class="form-popup" id="administratorForm">
    ...
    <div class="items">
        ...
        <p style="color: #666; font-size: 9px;">Thông tin giới thiệu về shop, thường là trang giới thiệu doanh nghiệp, sản phẩm</p>
    ...
    <div class="items">
        ...
        <p style="color: #666; font-style: italic; font-size: 9px !important;">(Nhập các sản phẩm mà doanh nghiệp cung cấp, mục đích khi người dùng cần mua sản phẩm nếu tồn tại trong phần miêu tả này, hệ thống sẽ tìm ra doanh nghiệp cung cấp và gửi yêu cầu báo giá)</p>
