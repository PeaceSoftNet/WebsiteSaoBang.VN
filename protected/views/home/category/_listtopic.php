    ...
    <div class="Navi-Br-NewsRv clearfix">
        ...
        <ul class="fr">
            ...
            if ($data->extension1 && isset($attributes[$data->extension1])) {
                $currUrl = array_merge($currUrl, array('aid' => $data->extension1, 'ext' => 1, 'extName' => ExtensionClass::utf8_to_ascii($attributes[$data->extension1])));
            ...
            if ($data->extension2 && isset($attributes[$data->extension2])) {
                $currUrl = array_merge($currUrl, array('aid' => $data->extension2, 'ext' => 2, 'extName' => ExtensionClass::utf8_to_ascii($attributes[$data->extension2])));
            ...
            if ($data->extension3 && isset($attributes[$data->extension3])) {
                $currUrl = array_merge($currUrl, array('aid' => $data->extension3, 'ext' => 3, 'extName' => ExtensionClass::utf8_to_ascii($attributes[$data->extension3])));
            ...
            if ($data->extension4 && isset($attributes[$data->extension4])) {
                $currUrl = array_merge($currUrl, array('aid' => $data->extension4, 'ext' => 4, 'extName' => ExtensionClass::utf8_to_ascii($attributes[$data->extension4])));
            ...
            if ($data->extension5 && isset($attributes[$data->extension5])) {
                $currUrl = array_merge($currUrl, array('aid' => $data->extension5, 'ext' => 5, 'extName' => ExtensionClass::utf8_to_ascii($attributes[$data->extension5])));
