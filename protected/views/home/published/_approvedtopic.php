<li>
    <h3 class="title-Br-NewsRv">
        <a class="fl" href="<?php echo Yii::app()->createUrl('home/TopicDetail', array('id' => $data->id, 'name' => ExtensionClass::utf8_to_ascii($data->title))); ?>"><?php echo $data->title; ?></a>
    ...
    <div class="Navi-Br-NewsRv clearfix">
        <div class="fl">
            ...
            <a class="detail-NewsRv" href="<?php echo Yii::app()->createUrl('topic/new', array('id' => $data->id)); ?>" ><i class="gr-icon-edit"></i> <span>Sửa tin</span></a>

            <?php if ($this->action->id != 'deletedTopic'): ?>
