...
<div class="grid_3">
                ...
                <?php if ($catId) { ?>
                    ...
                    if (is_array($attributesList)) {
                        foreach ($attributesList as $attrKey => $attrValue) {
                            echo '<li><span class="fl">' . $attrValue['name'] . '</span><div class="sltbox fr" id="leftA' . ($attrKey + 1) . '">
            <a class="slted" href="javascript:void(0);">' . ExtensionClass::getCurrentAttributes($attrKey) . '</a>
    ...
    <div class="block fil-browse">
        ...
        <div class="block-content">
            <p><a href="<?php echo Yii::app()->createUrl('home/all'); ?>">Tất cả danh mục</a></p>
            <div class="fil-br-categ">
                ...
                ?>
                <a href="<?php echo Yii::app()->createUrl('home/category', $currUrlParent); ?>"><h3><?php echo $catName; ?></h3></a>
                <ul>
                    <?php
                        ...
                        <ul>
                            ...
                            if (is_array($AttrVal['items'])) {
                                foreach ($AttrVal['items'] as $key1 => $childItem) {
                                    $currUrl = array_merge($currUrl, array('ext' => ($keyAid + 1), 'aid' => $childItem['id']));
                                    ...
                                    $countVal = GlobalComponents::numberFomat($countVal);
                                    echo '<li><a href="' . Yii::app()->createUrl('home/category', $currUrl) . '">' . $attributeName . '</a>&nbsp;<span>(' . $countVal . ')</span></li>';
                                }
                            }
                            ?>                            
                        </ul>
                            ...
                            <ul>
                                ...
                                if (is_array($AttrVal2['items'])) {
                                    foreach ($AttrVal2['items'] as $key2 => $childItem2) {
                                        ...
                                        $countVal = ExtensionClass::statisticDetail($statistic, $currUrl);
                                        $countVal = GlobalComponents::numberFomat($countVal);
                                        echo '<li><a href="' . Yii::app()->createUrl('home/category', $currUrl) . '">' . $attributeName2 . '</a>&nbsp;<span>(' . $countVal . ')</span></li>';
                                    }
                                }
                                ?>                            
                            </ul>
