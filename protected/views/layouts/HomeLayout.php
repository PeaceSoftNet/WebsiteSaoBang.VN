...
$page = isset($_GET['TopicModel_page']) ? ' - Trang ' . $_GET['TopicModel_page'] : '';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo CHtml::encode($this->pageTitle) . $page; ?></title>
            ...
            <div class="tophead">
                <div class="main newyear-event clearfix">
                    ...
                    <div class="Navi-tophead">
                        <ul class="clearfix">
                            <li <?php if (!in_array(Yii::app()->controller->action->id, array('published', 'profile', 'changerPassword', 'newsletter', 'approvedTopic', 'pendingApprovalTopic', 'deletedTopic'))) echo 'class="active"'; ?>>
