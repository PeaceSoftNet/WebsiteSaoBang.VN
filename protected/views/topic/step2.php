 ...
 *
 */
$this->pageTitle = 'Đăng rao vặt - Bước 2 | Rao vặt mục ' . $model->categoryId . ' ' . $model->childCatId;
...
?>
<?php $this->renderPartial('imgUpload'); ?>
<div class="block">
    <div class="bl-title clearfix">
        <h4><b class="org-clr">Bước 2:</b> Đăng rao vặt</h4>
    </div>
    <style type="text/css">
        .block input{background: #FFF !important;}
        #TopicModel_verifyCode{padding: 3px 5px; height: 20px; line-height: 20px;}
        .errorSummary ul li{font-style: italic; color: red;}
    </style>
    <div style="display: block; padding: 10px 20px;">
            ...
            <div class="cont">
                <div class="title">
                    ...
                    <p style="text-align: center">
                        <?php echo ExtensionClass::getCurrentCategory($model->categoryId); ?> &nbsp;&nbsp;*&nbsp;&nbsp; <?php echo ExtensionClass::getCurrentCategory($model->childCatId); ?>
                    </p>
                </div>            
            </div>
        </div>
        ...
        <div id="ajxContent">            
            ...
            if ($attrArr || $attrArr) {
                ...
                echo '<li class="z-id99">';
                if ($demandvalue) {
                    echo '<div class="sltboxnone"><strong>Nhu cầu:';
                    echo $form->radioButtonList($model, 'demand', $demandvalue, array('separator' => '', 'template' => '{input}&nbsp;{label} &nbsp;&nbsp;'));
                }
                echo '</div></li>';
                $num = 0;
                if ($attrArr) {
