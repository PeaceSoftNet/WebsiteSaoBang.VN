...
$listCategory = ExtensionClass::getListFilterCategory();
...
<div class="attibutesModel">
    ...
    <div class="right-popup w500">
        ...
        <div class="items">
            <?php echo $form->labelEx($model, 'beginPrice'); ?>
            <?php echo $form->textField($model, 'beginPrice'); ?>
            <?php echo $form->error($model, 'beginPrice'); ?>
        </div>
        <div class="items">
            <?php echo $form->labelEx($model, 'endPrice'); ?>
