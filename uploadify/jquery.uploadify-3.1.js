...
(function($) {
    ...
    var handlers = {
		...
		/**
                 * <div class="sm-loadimage">
                <p class="title"><span>Chờ tải: </span>ten_file_cua_user.jpg</p>
                <div class="clearfix">
                    <div class="timeload">
                        <div class="progress" style="width: 0%;"><a href=""><span></span></a></div>
                    </div>
                    <a class="cancel" href=""><i class="icon-delete"></i>&nbsp;Hủy</a>
                </div>
            </div>
                 */	
